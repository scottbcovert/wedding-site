(function(){
  ...
  function WeddingController($sce) {
    ...
    var eventHeader = 'Event Details',
    	...
    	weddingTime = 'Saturday, May 7th, 2016 at 5:00pm',
      bh = {
    	...
    	travelTabs = [
    		...
    		},
    		{
				...
				content: $sce.trustAsHtml('<p>For your convenience we have reserved room blocks under the name <b>Covert-Tam Wedding</b> at the following hotels; please make your travel plans by <b>April 1st</b> for a discounted rate.</p><div layout-gt-sm="row" class="fill-across layout-padding layout-align-end-start"><div flex-gt-sm="50"><b><u>Inn at Wilmington (Marriott)</u></b><p><a target="_blank" href="https://bookings.ihotelier.com/bookings.jsp?groupID=1561464&hotelID=15279">Make a Reservation</a><br/>Rate: $109/night<br/>Phone: 302.479.7900<br/>Address: 300 Rocky Run Pkwy<br/>Wilmington, DE 19803<br/><i>Complimentary Hot Breakfast Buffet</i></p></div><div flex-gt-sm="50"><b><u>DoubleTree (Hilton)</u></b><p><a target="_blank" href="https://group.doubletree.com/CovertTamWedding">Make a Reservation</a><br/>Rate: $117/night<br/>Phone: 302.478.6000<br/>Address: 4727 Concord Pike<br/>Wilmington, DE 19810</p></div></div>')
    		},
        {
          label: 'Sightseeing',
          header: 'Things to Do',
          imagePath: './assets/images/travel/Wilmington.jpg',
          content: $sce.trustAsHtml('<p>By coming to our wedding you will already be visiting Bellevue State Park so you\'re off to a great start, but there are plenty of other sites to see during the weekend. We\'d recommend a trip to:<div class="md-padding"><a target="_blank" href="https://www.winterthur.org/">Winterthur</a><br/><a target="_blank" href="https://www.hagley.org/">Hagley</a><br/><a target="_blank" href="https://www.delart.org/">Delaware Art Museum</a><br/><a target="_blank" href="https://longwoodgardens.org/">Longwood Gardens</a><br/><a target="_blank" href="https://www.winterthur.org/?p=1055">Point-to-Point</a><br/><a target="_blank" href="https://wilmingtonflowermarket.org/">Flower Market</a></div></p>')
        }
    	],
    	wpTabs = [
    		{    		
